...
public class SPUtils {
    ...
    public static SharedPreferences getSharedPreferences() {
        SharedPreferences sharedPreferences = AppUtils.getContext().getSharedPreferences(
    ...
    public static void logSP() {
        ...
        XLog.i("===========================================sharedPreferences===========================================",false);
        if (map.size() == 0) {
            XLog.i("sharedPreferences is null",false);
        } else {
            Set<? extends Map.Entry<String, ?>> entries = map.entrySet();
            for (Map.Entry<String, ?> entry : entries) {
                String key = entry.getKey();
                Object value = entry.getValue();
                XLog.i(key + "\t\t\t\t\t" + value,false);
            }
        }
        XLog.i("===========================================sharedPreferences===========================================",false);
    }
